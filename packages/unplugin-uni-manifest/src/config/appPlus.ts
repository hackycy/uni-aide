...
export interface AppPlus {
  ...
  distribute?: {
    ...
    ios?: {
      ...
      /**
       * 应用后台运行模式，详见 <https://uniapp.dcloud.net.cn/tutorial/app-ios-uibackgroundmodes.html> 和 <https://developer.apple.com/documentation/bundleresources/information-property-list/uibackgroundmodes>
       *
       * "audio" 后台播放音乐
       *
       * "location" 后台定位
       */
      UIBackgroundModes?: MaybeArray<'audio' | 'bluetooth-central' | 'bluetooth-peripheral' | 'external-accessory' | 'fetch' | 'location' | 'nearby-interaction' | 'network-authentication' | 'newsstand-content' | 'processing' | 'push-to-talk' | 'remote-notification' | 'voip'> | (string & {})
